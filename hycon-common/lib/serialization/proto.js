    ...
    GenesisBlockHeader.toObject = function toObject(message, options) {
        ...
        if (options.defaults) {
            ...
            if (options.bytes === String)
                ...
                object.miner = [];
                if (options.bytes !== Array)
                    object.miner = $util.newBuffer(object.miner);
            }
        }
        if (message.previousHash && message.previousHash.length) {
            object.previousHash = [];
...
$root.Tx = (function() {
    ...
    Tx.toObject = function toObject(message, options) {
        ...
        if (options.defaults) {
            ...
            object.recovery = 0;
            if (options.bytes === String)
                object.transitionSignature = "";
            else {
                object.transitionSignature = [];
                if (options.bytes !== Array)
                    object.transitionSignature = $util.newBuffer(object.transitionSignature);
            }
    ...
    NodeRef.toObject = function toObject(message, options) {
        ...
        if (options.defaults) {
            ...
            if (options.bytes === String)
                ...
                object.child = [];
                if (options.bytes !== Array)
                    object.child = $util.newBuffer(object.child);
            }
        }
        if (message.address != null && message.hasOwnProperty("address"))
