...
import { ConsensusFactor } from "hycon-common"
...
export class Options {
    ...
    public readonly externalDB: boolean = false
    ...
    constructor(userOptions: commandLineArgs.CommandLineOptions) {
        ...
        ConsensusFactor.networkid = this.networkid
        ConsensusFactor.lastNakamotoBlock = this.ghostHeight
        ConsensusFactor.lastGhostBlock = this.jabiruHeight
        ConsensusFactor.uncleReward = uncleReward
    }
